  ...
  <div class="Radioana">
    ...
    <table class="choices">
      ...
      <tr>
        ...
        <!-- <td></td>
        <td></td> -->
        <td>{{ this.chooseNumber[0] }}</td>
        <td>{{ this.chooseRatio[0] }}</td>
      </tr>
      <tr>
        <td>错误</td>

        <td>{{ this.chooseNumber[1] }}</td>
        <td>{{ this.chooseRatio[1] }}</td>
      </tr>
      <!-- <tr>
        <td>合计</td>
        <td></td>
    ...
    <div class="Correct">
      <div class="correctans">[正确答案]: 选项{{ this.correctAnswer }}</div>
      <div class="correctnum">
        [正确人数]: {{ this.chooseNumber[correctAnswer - 1] }}人
      </div>
      <div class="correctratio">
        [正确率]: {{ this.chooseRatio[correctAnswer - 1] }}
      </div>
    </div>
