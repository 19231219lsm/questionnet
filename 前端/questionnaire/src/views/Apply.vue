<template>
    <div id="nav">
        <div id="realNav">
            ...
            <span style="color: rgb(71,157,230)">报名问卷</span>
        </div>
        <div id="btn">
    ...
    <div id="Edit">
        <div id="left">
            ...
            <div class="questionList">
                ...
                <div class="questionType" @click="addLimitation">
                ...
                <div class="option">
                    <div>
                        <span style="font-size:16px">问卷限额: &nbsp;</span>
                        <el-input-number v-model="surveyNum" :min="0" :max="100000" placeholder="问卷限额">
                        </el-input-number>
                        &nbsp;
                        <i class="el-icon-more-outline" @click="showinfo" style="cursor: pointer"></i>
                    </div>
                </div>
                <div class="option">
                    <el-date-picker
...
export default {
    components: {
        Radio,Checkbox, Text, Evaluation, Judge, Limitation
    },
    data(){
        return {
            surveyNum: 0, //问卷限额
